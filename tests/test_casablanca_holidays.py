...
class TestXCASEidAlFitr:
    ...
    def test_eid_al_fitr_names_contain_predicted(self, explicit_dates):
        """Name suffix and predicted field must agree; some Eid al-Fitr
        entries are now reconciled (predicted: false) -- see
        tools/verify_predicted_dates.py."""
...
class TestXCASIslamicHolidays:
    ...
    def test_prophets_birthday_2025(self, explicit_dates):
        """Prophet's Birthday 2025 — confirmed September 5 (Morocco's
        religious authorities). Corrected from an erroneous September 4
        during Mawlid-cluster reconciliation (v2.1.2)."""
