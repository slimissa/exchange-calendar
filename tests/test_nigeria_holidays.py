...
class TestXNSAIslamicHolidays:
    def test_eid_al_adha_2025(self, explicit_dates):
        """Eid al-Adha 2025 — confirmed June 6 (Nigerian Federal Government,
        Ministry of Interior, announced 6th and 9th June 2025 as public
        holidays). Corrected from an erroneous June 30 during predicted-date
        reconciliation (v2.1.2) -- the original entry was off by ~24 days
        (roughly one lunar month), not a moon-sighting variance."""
