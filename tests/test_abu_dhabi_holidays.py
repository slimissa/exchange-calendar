...
class TestXTADIslamicHolidays:
    ...
    def test_prophets_birthday_2025(self, explicit_dates):
        """Prophet's Birthday 2025 — confirmed September 5 (UAE federal
        announcement, both public and private sector). Corrected from an
        erroneous September 4 during Mawlid-cluster reconciliation
        (v2.1.2) -- the entire 11-exchange cluster had shipped with the
        same date regardless of each country's actual announcement."""
